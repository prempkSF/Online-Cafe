...
namespace OnlineCafe
{
    ...
    public class ReadWriteFS<DataType>
    {
       public void ReadFiles(string fileName,out CustomList<DataType> values)
        {
            values=[];
        ...
        public void WriteFiles(string fileName,CustomList<DataType> values)
        {
